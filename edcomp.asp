...
<h1 align="center"><b>Изменение реквизитов организации.</b></h1>
<p>&nbsp;</p>
<p>
  <%if(ErrorMsg!=""){%>
</p>
    ...
    <table width="95%" border="1" bordercolor="#FFFFFF">
      <tr bordercolor="#9999FF"> 
        <td width="15%" bgcolor="#CCCCCC" bordercolor="#333333"> 
          <div align="right"> 
            <p><font color="#003399" size="3"><b>Организация</b>:</font>&nbsp;&nbsp;</p>
          </div>
        </td>
        ...
        <td bordercolor="#333333"> 
          <p><font color="#0000CC"> 
            ...
            / 
            <input type="text" name="kpp" maxlength="14" size="14" value="<%=kpp%>">
            </font></p>
        </td>
      </tr>
      <tr bordercolor="#9999FF"> 
...
<%} else {%>
<center>
  <h2><font color="#3333FF">Реквизиты организации обновлены!</font></h2>
</center>
<%}%>
<p>&nbsp;</p>
</body>
