...
<%}else{%>
      <table width="314" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="30" align="right"> 
            <ul>
              <li class="red"><a href="<%=url%>" class="red"><font color="#CC0000"><%=hname%></font></a> 
              </li>
            </ul>
          </td>
        </tr>
...
%>
      ...
      <p><a href="http://www.kadastr.ru/" target="_blank"><img src="rossnedvijimost.jpg" alt="Управление Роснедвижимости" width="130" height="122" border="0"></a>
      </p>
      <p>
        <%if (usok) {%>
    ...
    <td valign="top"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
        <tr> 
          <td valign="middle"> 
            <%if (tpm<7) {%>
            <p><a href="ednewsheading.asp?hid=<%=hid%>" class="sub">Настройки раздела</a> 
            | <a href="delpubheading.asp?hid=<%=hid%>" class="sub">Удалить раздел</a>
			| <a href="addnewsheading.asp?hid=<%=hid%>" class="sub">Создать подраздел</a>
            | <a href="addpub.asp?hid=<%=hid%>" class="sub"> + Добавить публикацию</a></p>
            <%}%>
</td>
        </tr>
      </table>
...
%>
            <table width="100%" border="0" cellspacing="0">
              <tr valign="top"> 
                ...
                <td> 
                  <p>[<%=pdat%>] <a href="<%=url%>"><%=pname%></a><br><%=digest%> [<a href="<%=url%>">далее</a>]</p>
                    <%if (usok) {%><p> <a href="pubresume.asp?pid=<%=pid%>&st=0" class="sub">Остановить</a> 
                    | <a href="delpub.asp?pid=<%=pid%>" class="sub">Удалить</a> 
                    | <a href="bloknews.asp?pid=<%=pid%>" class="sub">Разместить 
                    в блок</a> | <a href="edpub.asp?pid=<%=pid%>" class="sub">Редактировать</a>
					| <a href="addpubimg.asp?pid=<%=pid%>" class="sub">Добавить фото</a></p>
                   <%}%>
                </td>
              </tr>
            </table>
