...
<table width="314" border="0" cellspacing="0" cellpadding="0">
      ...
      <%if (usok) {%>
      <a href="addnewsheading.asp?hid=0" class="sub">+ Добавить раздел сайта<br></a>
      <%}%>
    </td>
	<br><!--begin of Top100-->
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
              <tr> <%}%>
                ...
                <td width="33%" valign="top" bgcolor="#FEFEFC"> 
                  <%if (imgname != "") {%>
                  <a href="<%=url%>"><img src="<%=imgname%>" border="0" ></a> 
                  <%}else{%>
                  <%}%>
                  <p><b><%=pname%></b>
                   <%if (usok) {%>
                   <p><a href="delpub.asp?pid=<%=pid%>" class="sub">Удалить</a> 
